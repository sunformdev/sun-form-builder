...
const WPformbuilderHiddenControl = ({ attributes, device, style }) => { // Làm thêm show hiden password
    ...
    return (
        <>
            <div className="wpformbuilder-form-group" style={{ width: `${width}`, 'display': 'none' }}>
                {!hide_label && (
                    <label className="wpformbuilder-form-group__label">{label}</label>
                )}
                <div className="wpformbuilder-form-control hidden">
...
export default WPformbuilderHiddenControl;